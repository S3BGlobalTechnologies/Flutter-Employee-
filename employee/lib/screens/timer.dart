...
import 'package:employee/model/thread_message.dart';
import 'package:employee/model/user.dart';
import 'package:employee/screens/edit_profile.dart';
import 'package:employee/widgets/thread_message.dart';
            ...
            children: [
              DrawerHeader(
                decoration: BoxDecoration(
                  color: Color.fromARGB(255, 221, 109, 197),
                ),
                child: Text(
                  'Your Name', // Replace with user name
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 16.0,
                  ),
              ...
              ListTile(
                leading: Icon(Icons.settings), // Add settings icon
                title: Text('Settings'),
                onTap: () {
